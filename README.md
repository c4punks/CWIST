...
- **CWIST**: 114,518 req/s at 0.53ms average latency (P50 0.44ms, P90 0.94ms, P99 2.11ms)
- **Axum**: 120,392 req/s at 0.79ms average latency (P50 0.69ms, P90 1.43ms, P99 2.56ms), same binary as the main run above
...
Measured commit: `d0b735a9a7607a0022b9c5cc843c07767ca1d343`. Release tag: `not recorded; identify this run by commit`.
Run: https://github.com/c4punks/CWIST/actions/runs/36125514926. Timestamp: `2026-09-25T10:54:35.467560+00:00`.
...
|---|---:|---:|---:|---:|---:|---:|
| CWIST Classic | 113,820 | 2.067 | 22.806 | 47.29 | 57.66 | 1,108,189 |
| CWIST | 146,386 | 2.692 | 14.218 | 14.16 | 25.84 | 115,451 |
| CWIST arena_max=1 | 145,534 | 2.725 | 13.076 | 19.22 | 30.66 | 119,039 |
| CWIST drain_chunk=8 | 146,690 | 2.703 | 13.534 | 14.29 | 25.92 | 113,627 |
| Axum | 112,772 | 3.477 | 18.197 | 15.06 | 17.17 | 186,060 |
| Gin | 78,086 | 6.845 | 81.077 | 28.32 | 29.74 | 314,892 |
| Spring Boot | 42,967 | 9.242 | 75.232 | 1,268.01 | 1,270.88 | 215,146 |
...
- CWIST Classic: 114,518 req/s; mean 0.529 ms; corrected P99.999 4.455 ms.
- Axum: 120,392 req/s; mean 0.785 ms; corrected P99.999 4.980 ms.
- Spring Boot: 44,998 req/s; mean 2.271 ms; corrected P99.999 31.235 ms.
...
|---|---:|---:|---:|---:|---:|---:|
| AMD EPYC 7763 64-Core Processor | 9 | 2.12 | 2.73 | 3.48 | 144,063 | 112,461 |
| AMD EPYC 9V74 80-Core Processor | 2 | 1.61 | 2.20 | 2.56 | 186,420 | 153,007 |
