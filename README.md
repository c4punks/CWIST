...
- **CWIST**: 113,889 req/s at 0.54ms average latency (P50 0.45ms, P90 0.92ms, P99 2.18ms)
- **Axum**: 118,392 req/s at 0.80ms average latency (P50 0.69ms, P90 1.48ms, P99 2.63ms), same binary as the main run above
...
Measured commit: `8ee190df79fbbb7507b3b50d015fc80e3f4853df`. Release tag: `not recorded; identify this run by commit`.
Run: https://github.com/c4punks/CWIST/actions/runs/35981351381. Timestamp: `2026-09-24T09:38:09.006227+00:00`.
...
|---|---:|---:|---:|---:|---:|---:|
| CWIST classic | 113,658 | 2.037 | 25.574 | 47.42 | 57.96 | 1,104,600 |
| CWIST C1M | 144,063 | 2.729 | 14.616 | 14.28 | 25.73 | 117,259 |
| CWIST C1M arena_max=1 | 143,856 | 2.727 | 15.247 | 18.76 | 30.24 | 110,243 |
| CWIST C1M drain_chunk=8 | 143,935 | 2.737 | 16.034 | 14.31 | 25.79 | 114,103 |
| Axum | 110,258 | 3.565 | 18.037 | 14.45 | 16.52 | 194,673 |
| Gin | 74,883 | 7.588 | 85.230 | 27.99 | 29.41 | 278,562 |
| Spring Boot | 43,729 | 9.042 | 62.719 | 1,283.22 | 1,286.09 | 210,083 |
...
- CWIST classic: 113,889 req/s; mean 0.538 ms; corrected P99.999 14.137 ms.
- Axum: 118,392 req/s; mean 0.800 ms; corrected P99.999 5.399 ms.
- Spring Boot: 43,174 req/s; mean 2.385 ms; corrected P99.999 31.742 ms.
...
|---|---:|---:|---:|---:|---:|---:|
| AMD EPYC 7763 64-Core Processor | 4 | 2.11 | 2.77 | 3.55 | 143,466 | 110,672 |
