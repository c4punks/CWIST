...
- **CWIST**: 117,184 req/s at 0.53ms average latency (P50 0.43ms, P90 0.95ms, P99 2.24ms)
- **Axum**: 121,272 req/s at 0.78ms average latency (P50 0.68ms, P90 1.43ms, P99 2.58ms), same binary as the main run above
...
Measured commit: `f9ea5d2870e12d40763c8074dfec970143c8259c`. Release tag: `not recorded; identify this run by commit`.
Run: https://github.com/c4punks/CWIST/actions/runs/36132896161. Timestamp: `2026-09-25T12:16:57.326148+00:00`.
...
|---|---:|---:|---:|---:|---:|---:|
| CWIST Classic | 112,296 | 2.077 | 20.598 | 47.06 | 57.68 | 1,086,836 |
| CWIST | 145,558 | 2.713 | 14.321 | 14.29 | 25.80 | 118,451 |
| CWIST arena_max=1 | 146,031 | 2.695 | 13.820 | 18.10 | 29.64 | 111,720 |
| CWIST drain_chunk=8 | 146,577 | 2.683 | 12.280 | 14.22 | 25.39 | 109,196 |
| Axum | 112,725 | 3.471 | 16.869 | 14.96 | 17.11 | 190,439 |
| Gin | 81,862 | 6.245 | 75.478 | 28.33 | 29.75 | 283,471 |
| Spring Boot | 45,577 | 8.650 | 54.234 | 1,288.77 | 1,291.64 | 220,347 |
...
- CWIST Classic: 117,184 req/s; mean 0.529 ms; corrected P99.999 5.042 ms.
- Axum: 121,272 req/s; mean 0.781 ms; corrected P99.999 5.302 ms.
- Spring Boot: 46,314 req/s; mean 2.208 ms; corrected P99.999 25.631 ms.
...
|---|---:|---:|---:|---:|---:|---:|
| AMD EPYC 7763 64-Core Processor | 10 | 2.11 | 2.73 | 3.48 | 144,201 | 112,593 |
