...
- **CWIST**: 154,418 req/s at 0.42ms average latency (P50 0.31ms, P90 0.78ms, P99 2.13ms)
- **Axum**: 163,029 req/s at 0.59ms average latency (P50 0.52ms, P90 1.01ms, P99 2.00ms), same binary as the main run above
...
Measured commit: `e3801a1550016fa4a63a4b1c342fb088d85bf3c9`. Release tag: `not recorded; identify this run by commit`.
Run: https://github.com/c4punks/CWIST/actions/runs/36122212147. Timestamp: `2026-09-25T10:17:22.870977+00:00`.
...
|---|---:|---:|---:|---:|---:|---:|
| CWIST Classic | 145,207 | 1.576 | 28.403 | 47.39 | 58.20 | 1,444,823 |
| CWIST | 185,917 | 2.234 | 26.082 | 14.28 | 26.04 | 152,288 |
| CWIST arena_max=1 | 189,804 | 2.140 | 14.128 | 18.58 | 30.45 | 155,335 |
| CWIST drain_chunk=8 | 189,415 | 2.121 | 18.622 | 14.31 | 26.09 | 150,741 |
| Axum | 154,222 | 2.529 | 17.589 | 13.90 | 16.11 | 246,326 |
| Gin | 112,869 | 4.814 | 59.999 | 27.48 | 29.03 | 408,289 |
| Spring Boot | 72,343 | 5.476 | 65.721 | 1,285.89 | 1,288.76 | 310,899 |
...
- CWIST Classic: 154,418 req/s; mean 0.415 ms; corrected P99.999 8.753 ms.
- Axum: 163,029 req/s; mean 0.586 ms; corrected P99.999 6.157 ms.
- Spring Boot: 74,419 req/s; mean 1.426 ms; corrected P99.999 25.069 ms.
