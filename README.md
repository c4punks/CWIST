...
- **CWIST**: 117,243 req/s at 0.53ms average latency (P50 0.45ms, P90 0.93ms, P99 2.23ms)
- **Axum**: 122,549 req/s at 0.77ms average latency (P50 0.67ms, P90 1.41ms, P99 2.50ms), same binary as the main run above
...
Measured commit: `c49345cfcae2f02b8beb78252553f46a083930c7`. Release tag: `not recorded; identify this run by commit`.
Run: https://github.com/c4punks/CWIST/actions/runs/35992654690. Timestamp: `2026-09-24T11:34:41.090671+00:00`.
...
|---|---:|---:|---:|---:|---:|---:|
| CWIST classic | 110,670 | 2.149 | 36.009 | 48.63 | 59.11 | 1,057,164 |
| CWIST C1M | 145,453 | 2.713 | 12.870 | 14.24 | 25.81 | 116,098 |
| CWIST C1M arena_max=1 | 145,522 | 2.714 | 13.456 | 17.41 | 28.96 | 106,926 |
| CWIST C1M drain_chunk=8 | 145,843 | 2.721 | 21.096 | 14.23 | 25.77 | 111,446 |
| Axum | 114,649 | 3.432 | 15.694 | 13.72 | 15.80 | 188,814 |
| Gin | 80,765 | 6.704 | 87.802 | 27.66 | 29.08 | 304,599 |
| Spring Boot | 44,664 | 8.857 | 75.576 | 1,279.46 | 1,282.32 | 223,080 |
...
- CWIST classic: 117,243 req/s; mean 0.529 ms; corrected P99.999 4.675 ms.
- Axum: 122,549 req/s; mean 0.770 ms; corrected P99.999 5.554 ms.
- Spring Boot: 43,226 req/s; mean 2.375 ms; corrected P99.999 28.181 ms.
...
|---|---:|---:|---:|---:|---:|---:|
| AMD EPYC 7763 64-Core Processor | 5 | 2.12 | 2.73 | 3.53 | 144,063 | 111,087 |
